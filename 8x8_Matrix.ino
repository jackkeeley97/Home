...
} else if (timeCount <  15382) {
  drawScreen(FILL33);
} else if (timeCount <  1) {

} else if (timeCount <  15384) {
  drawScreen(FILL34);
} else if (timeCount <  1) {

} else if (timeCount <  15836) {
  drawScreen(FILL35);
} else if (timeCount <  1) {

} else if (timeCount <  15388) {
  drawScreen(FILL36);
} else if (timeCount <  1) {

} else if (timeCount <  15390) {
  drawScreen(FILL37);
} else if (timeCount <  1) {

} else if (timeCount <  15392) {
  drawScreen(FILL38);
} else if (timeCount <  1) {

} else if (timeCount <  15394) {
  drawScreen(FILL39);
} else if (timeCount <  1) {
...
} else if (timeCount <  15402) {
  drawScreen(FILL41);
} else if (timeCount <  1) {

} else if (timeCount <  15404) {
  drawScreen(FILL42);
} else if (timeCount <  1) {

} else if (timeCount <  15406) {
  drawScreen(FILL43);
} else if (timeCount <  1) {

} else if (timeCount <  15408) {
  drawScreen(FILL44);
} else if (timeCount <  1) {

} else if (timeCount <  15410) {
  drawScreen(FILL45);
} else if (timeCount <  1) {

} else if (timeCount <  15412) {
  drawScreen(FILL46);
} else if (timeCount <  1) {

} else if (timeCount <  15414) {
  drawScreen(FILL47);
} else if (timeCount <  1) {

} else if (timeCount <  15420) {
  drawScreen(FILL48);
} else if (timeCount <  1) {


} else if (timeCount <  15422) {
  drawScreen(FILL49);
} else if (timeCount <  1) {

} else if (timeCount <  15424) {
  drawScreen(FILL50);
} else if (timeCount <  1) {

} else if (timeCount <  15426) {
  drawScreen(FILL51);
} else if (timeCount <  1) {

} else if (timeCount <  15428) {
  drawScreen(FILL52);
} else if (timeCount <  1) {

} else if (timeCount <  15430) {
  drawScreen(FILL53);
} else if (timeCount <  1) {

} else if (timeCount <  15432) {
  drawScreen(FILL54);
} else if (timeCount <  1) {

} else if (timeCount <  15434) {
  drawScreen(FILL55);
} else if (timeCount <  1) {

} else if (timeCount <  15440) {
  drawScreen(FILL56);
} else if (timeCount <  1) {


} else if (timeCount <  15442) {
  drawScreen(FILL57);
} else if (timeCount <  1) {

} else if (timeCount <  15444) {
  drawScreen(FILL58);
} else if (timeCount <  1) {

} else if (timeCount <  15446) {
  drawScreen(FILL59);
} else if (timeCount <  1) {

} else if (timeCount <  15448) {
  drawScreen(FILL60);
} else if (timeCount <  1) {

} else if (timeCount <  15450) {
  drawScreen(FILL61);
} else if (timeCount <  1) {

} else if (timeCount <  15452) {
  drawScreen(FILL62);
} else if (timeCount <  1) {

} else if (timeCount <  15454) {
  drawScreen(FILL63);
} else if (timeCount <  1) {

} else if (timeCount <  15480) {
  drawScreen(FILL64);
} else if (timeCount <  1) {
                                      // fast tempo - rows (TECHNOLOGIC)
} else if (timeCount <  15490) {
  drawScreen(C1);
} else if (timeCount <  1) {
...
} else if (timeCount <  15510) {
  drawScreen(C3);
} else if (timeCount <  1) {

} else if (timeCount <  15520) {
  drawScreen(C4);
} else if (timeCount <  1) {

} else if (timeCount <  15530) {
  drawScreen(C5);
} else if (timeCount <  1) {

} else if (timeCount <  15540) {
  drawScreen(C6);
} else if (timeCount <  1) {

} else if (timeCount <  15550) {
  drawScreen(C7);
} else if (timeCount <  1) {

} else if (timeCount <  15560) {
  drawScreen(C8);
} else if (timeCount <  1) {
                                      // Columns (TECHNOLOGIC)
                                      
} else if (timeCount <  15570) {
  drawScreen(R1);
} else if (timeCount <  1) {

} else if (timeCount <  15580) {
  drawScreen(R2);
} else if (timeCount <  1) {

} else if (timeCount <  15590) {
  drawScreen(R3);
} else if (timeCount <  1) {
...
} else if (timeCount <  15610) {
  drawScreen(R5);
} else if (timeCount <  1) {

} else if (timeCount <  15620) {
  drawScreen(R6);
} else if (timeCount <  1) {

} else if (timeCount <  15630) {
  drawScreen(R7);
} else if (timeCount <  1) {

} else if (timeCount <  15640) {
  drawScreen(R8);
} else if (timeCount <  1) {

                                  // REPEAT
} else if (timeCount <  15650) {
  drawScreen(C8);
} else if (timeCount <  1) {

} else if (timeCount <  15660) {
  drawScreen(C7);
} else if (timeCount <  1) {

} else if (timeCount <  15670) {
  drawScreen(C6);
} else if (timeCount <  1) {

} else if (timeCount <  15680) {
  drawScreen(C5);
} else if (timeCount <  1) {

} else if (timeCount <  15690) {
  drawScreen(C4);
} else if (timeCount <  1) {
...
} else if (timeCount <  15710) {
  drawScreen(C2);
} else if (timeCount <  1) {

} else if (timeCount <  15720) {
  drawScreen(C1);
} else if (timeCount <  1) {

                                  // REPEAT
} else if (timeCount <  15730) {
  drawScreen(R8);
} else if (timeCount <  1) {

} else if (timeCount <  15740) {
  drawScreen(R7);
} else if (timeCount <  1) {

} else if (timeCount <  15750) {
  drawScreen(R6);
} else if (timeCount <  1) {

} else if (timeCount <  15760) {
  drawScreen(R5); 
} else if (timeCount <  1) {

} else if (timeCount <  15770) {
  drawScreen(R4);
} else if (timeCount <  1) {

} else if (timeCount <  15780) {
  drawScreen(R3);
} else if (timeCount <  1) {

} else if (timeCount <  15790) {
  drawScreen(R2);
} else if (timeCount <  1) {
